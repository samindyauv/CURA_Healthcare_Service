...
public class CURA_Healthcare_Service extends baseTest {
    ...
    public void loginWithInvalidCredentials(String testCase,String username, String password, String expValidation) throws InterruptedException{
        ...
        switch (expValidation) {
            case "Login failed! Please ensure the username and password are valid." -> {
                Assert.assertEquals(webSteps.getText("LoginErrorMessages"), "Login failed! Please ensure the username and password are valid.", "Validation Failed");
            }
        }
    }
}
